...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.gct3l.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    // post api for reviews added to the server
    app.post("/reviews", async (req, res) => {
      const review = req.body;
      console.log("hit the reviews api", review);
